    ...
    for idx in tqdm.tqdm(range(n_samples), desc=f"Computing {name} criterion"):
        ...
        with torch.no_grad():
            ...
            if args.reference_model_name == args.scoring_model_name:
                ...
                assert torch.all(tokenized.input_ids[:, 1:] == labels), "Tokenizer is mismatch."
                logits_ref = reference_model(**tokenized).logits[:, :-1]
            rewritten_crit = criterion_fn(logits_ref, logits_score, labels)
        # result
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_file', type=str, default="../exp_test/results/xsum_gpt-neo-2.7B")
    parser.add_argument('--dataset', type=str, default="xsum")
    parser.add_argument('--dataset_file', type=str, default="../exp_test/data/xsum_gpt-neo-2.7B")
