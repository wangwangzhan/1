...
def experiment(args):
    ...
    for name in criterion_fns:
        ...
        for idx in tqdm.tqdm(range(n_samples), desc=f"Computing {name} criterion"):
            ...
            rewritten_text = data[idx]["rewritten"]
            perturbed_original = data[idx]["perturbed_original"]
            perturbed_rewritten = data[idx]["perturbed_rewritten"]
            original_crit = criterion_fn(args, scoring_model, scoring_tokenizer, original_text, perturbed_original)
            rewritten_crit = criterion_fn(args, scoring_model, scoring_tokenizer, rewritten_text, perturbed_rewritten)
            # result
